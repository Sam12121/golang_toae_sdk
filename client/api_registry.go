...
func (a *RegistryAPIService) AddRegistryExecute(r ApiAddRegistryRequest) (*ModelMessageResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/toae/registryaccount"
...
func (a *RegistryAPIService) AddRegistryGCRExecute(r ApiAddRegistryGCRRequest) (*ModelMessageResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/toae/registryaccount/gcr"
...
func (a *RegistryAPIService) CountImageStubsExecute(r ApiCountImageStubsRequest) (*ModelRegistryCountResp, *http.Response, error) {
	...
	localVarPath := localBasePath + "/toae/registryaccount/count/stubs"
...
func (a *RegistryAPIService) CountImagesExecute(r ApiCountImagesRequest) (*ModelRegistryCountResp, *http.Response, error) {
	...
	localVarPath := localBasePath + "/toae/registryaccount/count/images"
...
func (a *RegistryAPIService) DeleteRegistryExecute(r ApiDeleteRegistryRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/toae/registryaccount/{registry_id}"
...
func (a *RegistryAPIService) DeleteRegistryBulkExecute(r ApiDeleteRegistryBulkRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/toae/registryaccount/delete"
...
func (a *RegistryAPIService) GetRegistrySummaryExecute(r ApiGetRegistrySummaryRequest) (*ModelSummary, *http.Response, error) {
	...
	localVarPath := localBasePath + "/toae/registryaccount/{registry_id}/summary"
	localVarPath = strings.Replace(localVarPath, "{"+"registry_id"+"}", url.PathEscape(parameterValueToString(r.registryId, "registryId")), -1)
...
func (a *RegistryAPIService) GetSummaryAllExecute(r ApiGetSummaryAllRequest) (*map[string]ModelSummary, *http.Response, error) {
	...
	localVarPath := localBasePath + "/toae/registryaccount/summary"
...
func (a *RegistryAPIService) GetSummaryByTypeExecute(r ApiGetSummaryByTypeRequest) (*ModelSummary, *http.Response, error) {
	...
	localVarPath := localBasePath + "/toae/registryaccount/{registry_type}/summary-by-type"
...
func (a *RegistryAPIService) ListImageStubsExecute(r ApiListImageStubsRequest) ([]ModelImageStub, *http.Response, error) {
	...
	localVarPath := localBasePath + "/toae/registryaccount/stubs"
...
func (a *RegistryAPIService) ListImagesExecute(r ApiListImagesRequest) ([]ModelContainerImage, *http.Response, error) {
	...
	localVarPath := localBasePath + "/toae/registryaccount/images"
...
func (a *RegistryAPIService) SyncRegistryExecute(r ApiSyncRegistryRequest) (*ModelMessageResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/toae/registryaccount/{registry_id}/sync"
	localVarPath = strings.Replace(localVarPath, "{"+"registry_id"+"}", url.PathEscape(parameterValueToString(r.registryId, "registryId")), -1)
