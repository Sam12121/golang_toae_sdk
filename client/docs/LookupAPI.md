...
------------- | ------------- | -------------
[**GetCloudCompliances**](LookupAPI.md#GetCloudCompliances) | **Post** /toae/lookup/cloud-compliances | Retrieve Cloud Compliances data
[**GetCloudResources**](LookupAPI.md#GetCloudResources) | **Post** /toae/lookup/cloud-resources | Get Cloud Resources
[**GetCompliances**](LookupAPI.md#GetCompliances) | **Post** /toae/lookup/compliances | Retrieve Compliances data
[**GetContainerImages**](LookupAPI.md#GetContainerImages) | **Post** /toae/lookup/containerimages | Retrieve Container Images data
[**GetContainers**](LookupAPI.md#GetContainers) | **Post** /toae/lookup/containers | Retrieve Containers data
[**GetHosts**](LookupAPI.md#GetHosts) | **Post** /toae/lookup/hosts | Retrieve Hosts data
[**GetKubernetesClusters**](LookupAPI.md#GetKubernetesClusters) | **Post** /toae/lookup/kubernetesclusters | Retrieve K8s data
[**GetMalwares**](LookupAPI.md#GetMalwares) | **Post** /toae/lookup/malwares | Retrieve Malwares data
[**GetPods**](LookupAPI.md#GetPods) | **Post** /toae/lookup/pods | Retrieve Pods data
[**GetProcesses**](LookupAPI.md#GetProcesses) | **Post** /toae/lookup/processes | Retrieve Processes data
[**GetRegistryAccount**](LookupAPI.md#GetRegistryAccount) | **Post** /toae/lookup/registryaccount | Get Images in Registry
[**GetSecrets**](LookupAPI.md#GetSecrets) | **Post** /toae/lookup/secrets | Retrieve Secrets data
[**GetVulnerabilities**](LookupAPI.md#GetVulnerabilities) | **Post** /toae/lookup/vulnerabilities | Retrieve Vulnerabilities data
